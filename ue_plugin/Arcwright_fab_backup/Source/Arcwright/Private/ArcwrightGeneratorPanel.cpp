...
void SArcwrightGeneratorPanel::RegisterTab()
{
	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(
		...
		.SetTooltipText(LOCTEXT("TabTooltip", "Arcwright — The Bridge Between AI and Unreal Engine"))
					...
					[
						...
						[
							...
							: StaticCastSharedRef<SWidget>(
								...
								[
									SNew(STextBlock)
									.Text(LOCTEXT("WelcomeTagline", "The Bridge Between AI and Unreal Engine"))
...
void SArcwrightGeneratorPanel::RefreshChatList()
{
	...
	[
		...
		[
			SNew(STextBlock)
			.Text(LOCTEXT("WelcomeTagR", "The Bridge Between AI and Unreal Engine"))
			.Font(FCoreStyle::GetDefaultFontStyle("Italic", 11))
			.ColorAndOpacity(TextSecondary)
		]
	];
