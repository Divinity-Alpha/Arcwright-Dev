...
namespace ArcwrightColors
{
	...
	const FLinearColor BrandBlue(0.290f, 0.620f, 1.000f, 1.f);      // #4A9EFF
	const FLinearColor DeepBlue(0.102f, 0.361f, 0.753f, 1.f);       // #1A5CC0
	const FLinearColor AccentBlue(0.290f, 0.620f, 1.000f, 1.f);     // #4A9EFF
